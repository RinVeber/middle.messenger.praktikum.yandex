...
type PagesType = 'login' | 'register' | 'chat' | 'not-found' | 'server-error' | 'profile' | 'profile-change-password' | 'profile-change-data';
...
const pages = {
    ...
    'profile-change-password': [Pages.ProfileChangePasswordPage, {avatar: avatar}],
